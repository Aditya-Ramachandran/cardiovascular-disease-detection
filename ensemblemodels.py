...
class EnsembleModels():
    ...
    def __generate_report(self):
        ...
        report = '''
            ...
            This report provides an overview of the analysis conducted on the dataset. 
            ...
            - Mean age: 35.6
            - Standard deviation of income: $5000

            ### Visualizations

            ![Histogram](path/to/histogram.png)

            Figure 1: Histogram of the income distribution.

            ## Conclusion

            In conclusion, the analysis reveals interesting insights about the dataset. Further exploration is recommended to gain deeper insights.

            ---
            Generated by MyReportGenerator v1.0'''
        
        b64_report = base64.b64encode(report.encode()).decode()
        href = f'<a href="data:text/plain;base64,{b64_report}" download="report.txt">Download Report</a>'
        
        # Display the link
        st.markdown(href, unsafe_allow_html=True)

        st.write(self.__name)
    ...
    def predict(self):
        ...
        if btn:
            ...
            # report_button = st.selectbox('Would you like a report', options=['Yes', 'No'], key='report')
            # if st.session_state['report'] == 'Yes':
            #     self.__generate_report()
            # if st.session_state['report'] == 'No':
            #     st.write('Thank you')

            # st.write('Would you like a report?')
            # report_btn = st.button('generate report')
            # if report_btn == True:
            #     if st.session_state['predict']:
            # # if st.session_state['predict'] and report_btn == True:
            #         self.__generate_report()
